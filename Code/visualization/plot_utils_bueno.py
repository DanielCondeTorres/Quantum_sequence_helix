...
class ProteinPlotter:
    ...
    def plot_prob_with_sequences(self, probs: np.ndarray, decoder_fn, n_qubits: int, 
        ...
        plt.title(f'Top {top_k} Most Probable Sequences ({solver_name})', fontsize=16, fontweight='bold', pad=15)
    ...
    def plot_optimization(self, costs: list, solver_name: str, tick_size: int = 14):
        ...
        # Use explicit English titles; special-case QAOA
        title = f'{solver_name} Convergence - {len(costs)} Iterations'
