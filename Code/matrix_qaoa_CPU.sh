...
python main_final.py \
    ...
    --output_dir ../qaoa_2_cvar_angel_cpu \
    --solver qaoa \
    --backend qiskit
...
python main_final.py \
    ...
    --wheel_phase_deg 90 \
    --wheel_halfwidth_deg 90 \
    --output_dir ../qaoa_4_cvar_angel_cpu \
    --solver qaoa \
    --backend qiskit
python main_final.py \
    -L 6 \
    ...
    --wheel_phase_deg 90 \
    --wheel_halfwidth_deg 90 \
    --output_dir ../qaoa_6_cvar_angel_cpu \
    --solver qaoa \
    --backend qiskit
...
python main_final.py \
    ...
    --wheel_phase_deg 90 \
    --wheel_halfwidth_deg 90 \
    --output_dir ../qaoa_8_cvar_angel_cpu \
    --solver qaoa \
    --backend qiskit

echo "🚀 Iniciando L=10 en CPU (MPS)..."
python main_final.py \
    -L 10 \
    -R A,R,D,E,Q,G,L,M,F,P,S,T,W,Y,V,H \
    --membrane_mode wheel \
    --wheel_phase_deg 90 \
    --wheel_halfwidth_deg 90 \
    --output_dir ../qaoa_10_cvar_angel_cpu \
    --solver qaoa \
    --backend qiskit
